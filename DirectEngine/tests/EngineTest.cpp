...
namespace Engine
{
	...
	TEST(Collision, CollisionLayers)
	{
		...
		FixedList<CollisionData> collisionData{ testArena, 1 };
		...
		CollisionResult r = CollideWithWorld(collisionData, {}, { 0.f, 0.f, 1.f }, CollisionLayers::Floor);
		EXPECT_EQ(r.collider, &collisionData[0]);
		EXPECT_FLOAT_EQ(r.distance, 1.5f);

		r = CollideWithWorld(collisionData, {}, { 0.f, 0.f, -1.f }, CollisionLayers::Floor);
		EXPECT_EQ(r.collider, nullptr);

		r = CollideWithWorld(collisionData, {}, { 0.f, 0.f, 1.f }, CollisionLayers::None);
		EXPECT_EQ(r.collider, nullptr);
	}
	...
	{
		MemoryArena testArena{};
		FixedList<CollisionData> collisionData{ testArena, 2 };
		collisionData[0].aabbLocalPosition = { 0.f, 0.f, 0.f };
		collisionData[0].aabbLocalSize = { 1.f, 1.f, 1.f };
		collisionData[0].collisionLayers = CollisionLayers::Floor;
		collisionData[0].worldMatrix = XMMatrixAffineTransformation({ 1.f, 1.f, 1.f }, {}, XMQuaternionIdentity(), { 0.f, 0.f, 2.f });
		...
		r = CollideWithWorld(collisionData, { 0.f, 0.f, 5.f }, { 0.f, 0.f, -1.f }, CollisionLayers::Floor);
	...
	TEST(Collision, LocalPosition)
	{
		...
		r = CollideWithWorld(collisionData, { 0.2f, 0.f, 0.f }, { 0.f, 0.f, 1.f }, CollisionLayers::Floor);
		EXPECT_EQ(r.collider, &collisionData[0]);
	}
	...
	TEST(Collision, Rotation1)
	{
		...
		r = CollideWithWorld(collisionData, { 0.7f, 0.f, 0.f }, { 0.f, 0.f, 1.f }, CollisionLayers::Floor);
		EXPECT_EQ(r.collider, &collisionData[0]);

		r = CollideWithWorld(collisionData, { .71f, 0.f, 0.f }, { 0.f, 0.f, 1.f }, CollisionLayers::Floor);
		EXPECT_EQ(r.collider, nullptr);
	}
	...
	TEST(Collision, Rotation2)
	{
		...
		r = CollideWithWorld(collisionData, { 0.99f, 0.f, 0.f }, { 0.f, 0.f, 1.f }, CollisionLayers::Floor);
		EXPECT_EQ(r.collider, &collisionData[0]);

		r = CollideWithWorld(collisionData, { 1.01f, 0.f, 0.f }, { 0.f, 0.f, 1.f }, CollisionLayers::Floor);
		EXPECT_EQ(r.collider, nullptr);
	}
}
